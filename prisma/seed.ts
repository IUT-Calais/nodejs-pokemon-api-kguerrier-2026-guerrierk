...
async function main() {
    // Nettoyage des données en respectant les relations
    ...
    if (1) {
        await prisma.user.createMany({
            data: [
                { name: "Admin", email: 'admin@gmail.com', password: await bcrypt.hash('admin', 10), },
                {
                    name: "Kevin Guerrier",
